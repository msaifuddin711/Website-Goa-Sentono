...
@section('content')
    ...
    <section class="py-12 md:py-16 lg:py-24 relative overflow-hidden bg-cover bg-center bg-fixed" 
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center items-center max-w-sm sm:max-w-md md:max-w-none mx-auto">
            <a href="{{ route('reservasi') }}"
                class="w-full sm:w-auto min-w-[180px] sm:min-w-[220px] md:min-w-[250px] text-center bg-white bg-opacity-90 text-primary px-6 md:px-8 py-3 md:py-4 rounded-full font-bold text-sm md:text-base hover:bg-opacity-100 transition duration-300 transform hover:scale-105 shadow-2xl backdrop-blur-sm flex items-center justify-center">
